...
for filename in filenames:
    ...
    if( key not in plots.keys() ):
        ...
        plt.ylabel("Perceived Altitude (m)")
        # plt.legend()

        times[key] = 0
        energies[key] = 0

    plots[key].gca().plot(data["d_t"], - data["landing_pad_relative_z"].iloc[::-1])
...
for key in plots:
    plots[key].savefig("/home/joshua/Pictures/figures/pid_test_figures_u_altitude/" + key + ".png", bbox_inches="tight", pad_inches=0.05, transparent=False)
